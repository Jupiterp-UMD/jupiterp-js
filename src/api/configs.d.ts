...
export declare function coursesConfigToQueryParams(cfg: CoursesConfig): URLSearchParams;
/**
...
export declare function sectionsConfigToQueryParams(cfg: SectionsConfig): URLSearchParams;
/**
...
export declare function instructorsConfigToQueryParams(cfg: InstructorsConfig): URLSearchParams;
